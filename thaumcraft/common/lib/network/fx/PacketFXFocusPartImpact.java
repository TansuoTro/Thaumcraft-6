...
/*    */   extends Object
/*    */   implements IMessage, IMessageHandler<PacketFXFocusPartImpact, IMessage>
/*    */ {
/*    */   double x;
/*    */   double y;
/*    */   double z;
...
/* 57 */     Minecraft.func_71410_x().func_152344_a(new Runnable() { public void run() { PacketFXFocusPartImpact.this.processMessage(message); } });
/* 58 */     return null;
/*    */   }
/*    */   
...
/* 64 */     int amt = Math.max(1, 15 / partKeys.length);
...
/* 71 */               .nextGaussian() * 0.15D, r.nextGaussian() * 0.15D, r.nextGaussian() * 0.15D);  
/*    */     } 
/*    */   }
/*    */ }


/* Location:              D:\工程开发\Cracked\Thaumcraft-1.12.2-6.1.BETA26.jar!\thaumcraft\common\lib\network\fx\PacketFXFocusPartImpact.class
