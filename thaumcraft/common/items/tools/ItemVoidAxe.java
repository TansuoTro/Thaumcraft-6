...
/* 27 */     super(enumtoolmaterial, 8.0F, -3.0F);
/* 28 */     func_77637_a(ConfigItems.TABTC);
/* 29 */     setRegistryName("void_axe");
/* 30 */     func_77655_b("void_axe");
...
/*    */ 
/*    */   
/* 61 */   public Set<String> getToolClasses(ItemStack stack) { return ImmutableSet.of("axe"); }
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/* 77 */       !(entity instanceof EntityPlayer) || FMLCommonHandler.instance().getMinecraftServerInstance().func_71219_W()))
/*    */     {
/*    */       
/* 80 */       ((EntityLivingBase)entity).func_70690_d(new PotionEffect(MobEffects.field_76437_t, 80));
/*    */     }
/*    */ 
/*    */     
...
/* Location:              D:\工程开发\Cracked\Thaumcraft-1.12.2-6.1.BETA26.jar!\thaumcraft\common\items\tools\ItemVoidAxe.class
