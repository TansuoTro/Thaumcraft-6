...
/*    */   
/*    */   static  {
/* 19 */     generateIcosahedron();
/*    */   }
/*    */ 
/*    */   
/*    */   private static void generateIcosahedron() {
/* 24 */     verts = new Vector3[12];
/*    */     
...
/* 82 */     icosahedron7.verts[i * 4] = new Vertex5(vec1, u1, v1); icosahedron4.verts[i * 3] = new Vertex5(vec1, u1, v1);
/* 83 */     icosahedron7.verts[i * 4 + 1] = new Vertex5(vec2, u2, v2); icosahedron4.verts[i * 3 + 1] = new Vertex5(vec2, u2, v2);
/* 84 */     icosahedron7.verts[i * 4 + 3] = new Vertex5(vec3, u3, v3); icosahedron7.verts[i * 4 + 2] = new Vertex5(vec3, u3, v3); icosahedron4.verts[i * 3 + 2] = new Vertex5(vec3, u3, v3);
/* 85 */     i++;
/*    */   }
/*    */ 
/*    */ 
/*    */   
/* 90 */   public static Matrix4 getRenderMatrix(Vector3 position, Rotation rotation, double scale) { return (new Matrix4()).translate(position).apply(new Scale(scale)).apply(rotation); }
/*    */ }


/* Location:              D:\工程开发\Cracked\Thaumcraft-1.12.2-6.1.BETA26.jar!\thaumcraft\codechicken\lib\render\CCModelLibrary.class
